...
#' fit data with normal distributions.
#' 
...
#' details.
#' 
#' A premade wrapper for \code{mFit} such that only the constant, x, and pnorm
#' terms are displayed. See \code{mFit} for more details.
#' 
